...
function produceFormHtml(artists, formId, buttonId){
	...
	return "<div class='row' id='" + formId + "'><div class='col-sm-12' id='artistForm'><div class='panel panel-default'><div class='panel-heading'><h1>Choose Additional Artists to be Included to the Station</h1></div><div class='panel-body'><div>" + checkboxes + "</div></div><!--panel-body--><button class='btn btn-default' id='" + buttonId + "'>Create Station</button></div><!--pane-default--></div><!--artistForm--></div><!--row-->";
}
